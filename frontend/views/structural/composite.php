...
<p>
    В контроллере StructuralController по методу actionComposite есть пример реализации Composite
</p>
<p>
    <a href="https://refactoring.guru/ru/design-patterns/composite">Ссылка на подробную статью</a>
</p>
<p>
