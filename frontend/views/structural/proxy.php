...
<p>
    В контроллере StructuralController по методу actionProxy есть пример реализации Proxy
</p>
<p>
    <a href="https://refactoring.guru/ru/design-patterns/proxy">Ссылка на подробную статью</a>
</p>
<pre>
<?php

use frontend\patterns\structural\proxy\Proxy;
use frontend\patterns\structural\proxy\RealSubject;
