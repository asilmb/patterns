...
<p>
    В контроллере StructuralController по методу actionFacade есть пример реализации Facade
</p>
<p>
    <a href="https://refactoring.guru/ru/design-patterns/facade">Ссылка на подробную статью</a>
</p>
<pre>
<?php

use frontend\patterns\structural\facade\Facade;
use frontend\patterns\structural\facade\Subsystem1;
use frontend\patterns\structural\facade\Subsystem2;
