...
<p>
    В контроллере CreationController по методу actionPrototype есть пример реализации Prototype
</p>
<p>
    <a href="https://refactoring.guru/ru/design-patterns/prototype">Ссылка на подробную статью</a>
</p>
<p>
	<?php if ($p1->primitive === $p2->primitive) {
...
<p>
	<?php if ($p1->component === $p2->component) {
