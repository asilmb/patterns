...
<p>
    В контроллере BehaviorPatternsController по методу Visitor есть пример реализации Visitor
...
<?php foreach ($visitor1Answers as $answer) { ?>
    <p>  <?= $answer ?></p>
<?php } ?>
...
<?php foreach ($visitor2Answers as $answer) { ?>
    <p>  <?= $answer ?></p>
<?php } ?>
