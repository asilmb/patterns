<?php use frontend\patterns\behavior\iterator\WordsCollection;
use frontend\patterns\behavior\memento\Caretaker;
use frontend\patterns\behavior\memento\Originator; ?>

<h1>Memento</h1>

<p>
    В контроллере BehaviorPatternsController по методу Memento есть пример реализации Memento

</p>
<a href="https://refactoring.guru/ru/design-patterns/memento">Ссылка на подробную статью </a>
